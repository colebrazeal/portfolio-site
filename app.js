...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const height = window.innerHeight * window.devicePixelRatop;
    const options = {
    ...
    let rtA = new THREE.WebGLRenderer(width, height, options);
    let rtB = new THREE.WebGLRenderer(width, height, options);
    ...
    ctx.font = `bold ${fontsize}px Test Söhne`; //!!!!CHANGE FONT LATER!!!!
    ctx.textAlign = "center";
    ctx.textBaseline = "middle";
    ctx.textRendering = "geometricPrecision";
    ctx.imageSmoothingEnabled = true;
    ctx.imageSmoohtingQuality = "high";
